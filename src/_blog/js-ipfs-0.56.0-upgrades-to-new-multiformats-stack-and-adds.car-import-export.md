...
date: 2021-06-29
permalink: "/2021-06-29-js-ipfs-0-56/"
translationKey: ''
...
`js-IPFS@0.56.0` is on it's way to the moon with a new data layer and import/export for [Content Addressable aRchive](https://ipld.io/specs/transport/car/)s along with many small bug fixes and performance improvements!
