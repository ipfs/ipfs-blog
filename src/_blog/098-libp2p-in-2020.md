...
- We built and released Gossipsub, wrote a [new explainer](https://github.com/libp2p/specs/tree/master/pubsub/gossipsub), and later [enhanced with security extensions](https://blog.ipfs.eth.link/2020-05-20-gossipsub-v1.1/) including peer scoring, opportunistic grafting, peer exchange, and other features.
...
- We simplified the go-libp2p codebase by centralizing abstractions and interfaces under the [go-libp2p-core module](https://blog.ipfs.eth.link/2020-05-20-gossipsub-v1.1/), decommissioning 12+ repos along the way. Further codebase simplification is on the roadmap for 2020.
...
- [https://blog.ipfs.eth.link/2020-02-10-our-focus-for-2020/](https://blog.ipfs.eth.link/2020-02-10-our-focus-for-2020/)
