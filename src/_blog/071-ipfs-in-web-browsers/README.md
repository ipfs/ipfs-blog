...
![Stages of browser integration](./stages-of-browser-integration.png)
...
![Enabling IPFS Companion in Brave](./enabling-ipfs-companion-in-brave.gif)
...
![IPFS configuration option for embedded node using Chrome sockets API in Brave](./enable-embedded-node-in-brave.png)
...
![Opera announcing ENS and IPFS at EthCC March 2019](./opera-announcement.png)
