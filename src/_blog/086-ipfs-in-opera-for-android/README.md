...
[![Screenshot of Opera for Android in the Google Play Store, linked to the URL of that page](./opera-android-play-store.png)](https://play.google.com/store/apps/details?id=com.opera.browser)
...
![Screenshots of entering an ipfs:// address in Opera for Android, and loading it.](./opera-android-protocol-demo.png)
...
![Screenshot of a failed image test in the IPFS protocol handler smoketests.](./opera-android-test-page.png)
...
![IPFS HTTP gateway configuration in the Crypto Wallet settings in Opera for Android](./opera-android-settings.gif)
